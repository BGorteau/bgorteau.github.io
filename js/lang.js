const translations = {
  ...
  fr: {
    ...
    // ===== PROJECT NUMBER 3 =====
    proj_3_h3: "Visualisation de données sur l'éducation",
    proj_3_skill_1: "Python",
    proj_3_skill_2: "Visualisation de données",
    proj_3_skill_3: "Matplotlib",
    proj_3_desc: "Visualisations de données sur l'éducation réalisées avec les données de l'Institut de statistique de l'Unesco (ISU).",
    // ===== PROJECT NUMBER 4 =====
    proj_4_h3: "Prédiction des prix des logements Airbnb à New York",
    proj_4_skill_1: "Python",
    proj_4_skill_2: "Machine Learning",
    proj_4_skill_3: "scikit-learn",
    proj_4_desc: "Prédiction des prix des logements Airbnb à New York en utilisant la librairie de machine learning scikit-learn.",
    // ===== PROJECT NUMBER 5 =====
  ...
  en: {
    ...
    // ===== PROJECT NUMBER 3 =====
    proj_3_h3: "Education Data Visualization",
    proj_3_skill_1: "Python",
    proj_3_skill_2: "Data Visualization",
    proj_3_skill_3: "Matplotlib",
    proj_3_desc: "Education data visualizations realized with the Unesco Institute for Statistics (UIS) data.",
    // ===== PROJECT NUMBER 4 =====
    proj_4_h3: "New York Airbnb Price Prediction",
    proj_4_skill_1: "Python",
    proj_4_skill_2: "Machine Learning",
    proj_4_skill_3: "scikit-learn",
    proj_4_desc: "Predicting Airbnb housing prices in New York using the scikit-learn machine learning library.",
    // ===== PROJECT NUMBER 5 =====
